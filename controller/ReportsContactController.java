...
/**
 * This class controls the contact report page of the GUI
 */
public class ReportsContactController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        appsTable.setItems(Database.getAppointmentsByContactId(selectedContactId));
    ...
    /**
     * This method gets all contact names from the SQL Server and sets them to be the options for the contact field.
     * By using a for Each lambda method we are able to remove multiple lines of code, and remove member defining,
     * making this method easier to read.
     *
     * @param mouseEvent
     * @throws SQLException
     */
    ...
    /**
     * This method sets the table view items to the contact filtered appointments
     * @param actionEvent
     */
    @FXML
    private void contactAction(ActionEvent actionEvent) throws SQLException {
        selectedContactId = ContactsQuery.getId(contactField.getValue());
        appsTable.setItems(Database.getAppointmentsByContactId(selectedContactId));
    }
}
