...
/**
 * This class controls the type report page of the GUI
 */
public class ReportsTypeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        int selectedType = 0;
        appsTable.setItems(Database.getAppointmentsByContactId(selectedType));
    ...
    /**
     * This method sets the options to only the available types
     * @param mouseEvent
     * @throws SQLException
     */
    @FXML
    private void typeClick(MouseEvent mouseEvent) throws SQLException {
        ObservableList<String> types = AppsQuery.selectDistinctTypes();
        typeField.setItems(types);
    }

    /**
     * This method sets the table view items to the type filtered appointments
     * @param actionEvent
     */
    @FXML
    private void typeAction(ActionEvent actionEvent) {
        appsTable.setItems(Database.getAppointmentsByType(typeField.getValue()));
    }
}
