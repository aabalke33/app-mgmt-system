...
/**
 * This class controls the appointment modify page of the GUI
 */
public class AppsModController implements Initializable {
    /**
     * This variable stores the appointment selected to be modified
     */
...
//        });
    ...
    /**
     * This method fills the field values at load based on the selected appointment
    ...
    public void setAppointment(Appointment selectedAppointment) throws SQLException {
        ...
        contactField.setValue(ContactsQuery.getName(selectedAppointment.getContactId()));
        ...
        ZonedDateTime s = LocalDateTime.of(selectedAppointment.getStartDate(), selectedAppointment.getStartTime())
                .atZone(ZoneId.ofOffset("",ZoneOffset.UTC));
        ZonedDateTime e = LocalDateTime.of(selectedAppointment.getEndDate(), selectedAppointment.getEndTime())
                .atZone(ZoneId.ofOffset("",ZoneOffset.UTC));
        ...
        startTimeField.setText(startTime.format(DateTimeFormatter.ofPattern("[H:]mm")));

        endDateField.setValue(endDate);
        endTimeField.setText(endTime.format(DateTimeFormatter.ofPattern("[H:]mm")));
    }
    /**
    ...
    private void saveClick(ActionEvent actionEvent) throws SQLException, IOException {
        ...
        if ((startTimeUTC.isAfter(businessStart) || startTimeUTC.isBefore(businessEnd)) &&
            ...
            if (AppsQuery.selectByRange(start, end, customerId).size() == 1) {
                AppsQuery.update(selectedAppointment.getAppointmentId(), title, description, location, contact,
...
//            contactNames.addAll(contact.getContactName());
//        }
//      Lambda Solution
